  ...
  return (
    <div className='abtUs'>
      ...
      <div className="abtMain">
        <div className="abt-us p-12 text-start mt-10">
          <h3 className='text-4xl font-bold mb-6'>Welcome to HOCDAVI Investment Limited!</h3>
          <p className=' text-lg'>
        ...
        <div className="why-chs p-12 text-center mt-20 bg-slate-800 text-slate-100">
          <h3 className='text-4xl font-bold mb-8 text-start'>Why Choose HOCDAVI Investment Limited ?</h3>
        ...
        <div className="coreValues p-12 text-start mt-10">
          <h3 className='text-4xl font-bold mb-6'>Our Core Values</h3>
        ...
        <div className="join p-12 mt-10 text-center">
          <h3 className='text-6xl font-bold mb-6'>Join Us Now!</h3>
          <p className=' text-lg'>
